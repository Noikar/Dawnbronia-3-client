...
{
	static const char secret[4][ACC_PWLEN + 1] = {"\000cgf\000de8etzdf\000dx", "jrfa\000v7d\000drt\000edm",
...
static int parse_reply(
    const unsigned char *buf, int len, struct acc_char *chars, int maxchars, int *pcount, int *padmin)
{
